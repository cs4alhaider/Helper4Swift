...
public extension String {
    ...
    #elseif os(macOS)
    /// Shortcut of: NSImage(named: "imageName")
    var asImage: NSImage? {
    ...
    #elseif os(macOS)
    /// Shortcut for `NSStoryboard(name: "NSStoryboard", bundle: nil)`
    var asStoryboard: NSStoryboard {
        return NSStoryboard(name: self, bundle: nil)
    }
    #endif
